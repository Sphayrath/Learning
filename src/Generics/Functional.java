...
/**
 * Created by VFilin on 19.04.2016.
 */
...
public class Functional {
    ...
    //чтобы объеденить его с наапливаемым результатом,
    ...
    //игнорируя возвращаемое значение. Объект функции может действовать
    ...
    //Применяет унарный предикат к каждому элементу последовательнсти
    ...
    //Для использования обобщенных методов необходимо создать объекты функций для их адаптации
